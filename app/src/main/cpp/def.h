...
#define PORN_HEADER()                                                        \
  ...
  snprintf(headerBuffer, 288,                                                \
           ...
           "OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.0.3 "  \
           "Mobile/15E148 Safari/604.1\r\n"                                  \
           "X-Forwarded-For: %d.%d.%d.%d\r\n"                                \
           "\r\n",                                                           \
           url, randomIP(1, 255), randomIP(1, 255), randomIP(1, 255),        \
           randomIP(1, 255));

#define PORNHUB_HEADER()                                                        \
  char headerBuffer[256];                                                    \
  snprintf(headerBuffer, 256,                                                \
           "GET /view_video.php?viewkey=%s HTTP/1.1\r\n"                     \
