...
/* package */ final class SimplePlayerControlViewLayoutManager {
  ...
  private final SimplePlayerControlView styledPlayerControlView;
  ...
  public SimplePlayerControlViewLayoutManager(SimplePlayerControlView styledPlayerControlView) {
    ...
    controlsBackground = styledPlayerControlView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_controls_background);
    centerControls = styledPlayerControlView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_center_controls);

    // Relating to Minimal Layout
    minimalControls = styledPlayerControlView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_minimal_controls);

    // Relating to Bottom Bar View
    bottomBar = styledPlayerControlView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_bottom_bar);

    // Relating to Bottom Bar Left View
    timeView = styledPlayerControlView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_time);
    timeBar = styledPlayerControlView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_progress);

    // Relating to Bottom Bar Right View
    basicControls = styledPlayerControlView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_basic_controls);
    extraControls = styledPlayerControlView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_extra_controls);
    extraControlsScrollView =
        styledPlayerControlView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_extra_controls_scroll_view);
    overflowShowButton = styledPlayerControlView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_overflow_show);
    View overflowHideButton = styledPlayerControlView.findViewById(com.google.android.exoplayer2.ui.R.id.exo_overflow_hide);
    ...
    fadeOutAnimator.addListener(
        new AnimatorListenerAdapter() {
          ...
          public void onAnimationStart(Animator animation) {
            if (timeBar instanceof com.google.android.exoplayer2.ui.DefaultTimeBar && !isMinimalMode) {
              ((com.google.android.exoplayer2.ui.DefaultTimeBar) timeBar).hideScrubber(DURATION_FOR_HIDING_ANIMATION_MS);
            }
          }
    ...
    fadeInAnimator.addListener(
        new AnimatorListenerAdapter() {
          ...
          public void onAnimationStart(Animator animation) {
            ...
            if (timeBar instanceof com.google.android.exoplayer2.ui.DefaultTimeBar && !isMinimalMode) {
              ((com.google.android.exoplayer2.ui.DefaultTimeBar) timeBar).showScrubber(DURATION_FOR_SHOWING_ANIMATION_MS);
            }
          }
        });
    ...
    float translationYForProgressBar =
        resources.getDimension(com.google.android.exoplayer2.ui.R.dimen.exo_styled_bottom_bar_height)
            - resources.getDimension(com.google.android.exoplayer2.ui.R.dimen.exo_styled_progress_bar_height);
    float translationYForNoBars = resources.getDimension(com.google.android.exoplayer2.ui.R.dimen.exo_styled_bottom_bar_height);
  ...
  private void onOverflowButtonClick(View v) {
    resetHideCallbacks();
    if (v.getId() == com.google.android.exoplayer2.ui.R.id.exo_overflow_show) {
      overflowShowAnimator.start();
    } else if (v.getId() == com.google.android.exoplayer2.ui.R.id.exo_overflow_hide) {
    ...
    if (timeBar != null) {
      ...
      int timeBarMarginBottom =
          styledPlayerControlView
              .getResources()
              .getDimensionPixelSize(com.google.android.exoplayer2.ui.R.dimen.exo_styled_progress_margin_bottom);
      ...
      if (timeBar instanceof com.google.android.exoplayer2.ui.DefaultTimeBar) {
        com.google.android.exoplayer2.ui.DefaultTimeBar defaultTimeBar = (DefaultTimeBar) timeBar;
        if (isMinimalMode) {
  ...
  private boolean shouldHideInMinimalMode(View button) {
    int id = button.getId();
    return (id == com.google.android.exoplayer2.ui.R.id.exo_bottom_bar
        ...
        || id == com.google.android.exoplayer2.ui.R.id.exo_rew_with_amount
        || id == com.google.android.exoplayer2.ui.R.id.exo_ffwd
        || id == com.google.android.exoplayer2.ui.R.id.exo_ffwd_with_amount);
  }
