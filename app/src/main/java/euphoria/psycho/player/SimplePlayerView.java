...
public class SimplePlayerView extends FrameLayout {
    ...
    public SimplePlayerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, /* defStyleAttr= */ 0);
    }

    @SuppressWarnings({"nullness:argument", "nullness:method.invocation"})
    public SimplePlayerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        if (customController != null) {
            ...
            controller.setOnFullScreenModeChangedListener(new OnFullScreenModeChangedListener() {
                @Override
    ...
    /**
     * Set the {@link com.google.android.exoplayer2.ui.AspectRatioFrameLayout.AspectRatioListener}.
     *
    ...
    private final class ComponentListener
        ...
        public void onTracksChanged(TrackGroupArray trackGroups, TrackSelectionArray selections) {
            ...
            Player player = checkNotNull(SimplePlayerView.this.player);
